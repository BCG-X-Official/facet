...
setup(
    ...
    url="https://git.sourceai.io/alpha/gamma-yieldengine",  # Optional
    ...
    install_requires=[
        ...
        "gamma-ml @ git+ssh://git@git.sourceai.io/BCG/gamma-ml.git@1.1.0#egg=gamma.ml",
    ],
    dependency_links=[],
    # Optional
