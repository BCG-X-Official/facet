    ...
    try:
        ...
        assert np.hstack([m.values for m in redundancy_matrix]) == (
            pytest.approx(
                np.array(
                    [
                        [1.0, 0.044, 0.643, 0.654, 1.0, 0.027]
                        + [0.414, 0.341, 1.0, 0.004, 0.618, 0.509],
                        [0.044, 1.0, 0.235, 0.235, 0.027, 1.0]
                        + [0.092, 0.132, 0.004, 1.0, 0.001, 0.001],
                        [0.643, 0.235, 1.0, 0.993, 0.414, 0.092]
                        + [1.0, 0.752, 0.618, 0.001, 1.0, 0.746],
                        [0.654, 0.235, 0.993, 1.0, 0.341, 0.132]
                        + [0.752, 1.0, 0.509, 0.001, 0.746, 1.0],
                    ]
                ),
                abs=0.02,
            )
...
def test_model_inspection_classifier_interaction(
    ...
    try:
        ...
        assert redundancy_matrix.values == pytest.approx(
            np.array(
                [
                    [1.000, 0.001, 0.278, 0.163],
                    [0.001, 1.000, 0.007, 0.002],
                    [0.278, 0.007, 1.000, 0.631],
                    [0.163, 0.002, 0.631, 1.000],
                ]
            ),
            abs=0.02,
        )
        ...
        assert redundancy_matrix.values == pytest.approx(
            np.array(
                [
                    [1.000, 0.631, 0.163, 0.002],
                    [0.631, 1.000, 0.278, 0.007],
                    [0.163, 0.278, 1.000, 0.001],
                    [0.002, 0.007, 0.001, 1.000],
                ]
            ),
            abs=0.02,
        )
        assert model_inspector.feature_redundancy_matrix(
            ...
            np.array(
                [
                    [0.424, 0.268, 0.069, 0.001],
                    [0.306, 0.485, 0.135, 0.003],
