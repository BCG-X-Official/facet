...
def test_model_inspection_classifier_binary(
    ...
    assert association_matrix.values == pytest.approx(
        np.array(
            [
                [1.0, 0.627, 0.149, 0.004],
                [0.627, 1.0, 0.25, 0.007],
                [0.149, 0.25, 1.0, 0.0],
                [0.004, 0.007, 0.0, 1.0],
            ]
        ),
...
def test_model_inspection_classifier_multi_class(
    ...
    try:
        ...
        assert np.hstack([m.values for m in synergy_matrix]) == pytest.approx(
            np.array(
                [
                    [1.0, 0.0, 0.055, 0.051, 1.0, 0.006]
                    + [0.422, 0.415, 1.0, 0.001, 0.08, 0.093],
                    [0.059, 1.0, 0.049, 0.052, 0.073, 1.0]
                    + [0.11, 0.122, 0.059, 1.0, 0.2, 0.199],
                    [0.003, 0.0, 1.0, 0.003, 0.028, 0.003]
                    + [1.0, 0.043, 0.009, 0.0, 1.0, 0.031],
                    [0.002, 0.0, 0.002, 1.0, 0.03, 0.001]
                    + [0.046, 1.0, 0.014, 0.003, 0.037, 1.0],
                ]
            ),
            abs=0.02,
        )
        ...
        assert np.hstack([m.values for m in redundancy_matrix]) == (
            pytest.approx(
                np.array(
                    [
                        [1.000, 0.044, 0.608, 0.621, 1.000, 0.027]
                        + [0.239, 0.200, 1.000, 0.004, 0.568, 0.462],
                        [0.041, 1.000, 0.224, 0.223, 0.025, 1.000]
                        + [0.082, 0.116, 0.004, 1.000, 0.001, 0.001],
                        [0.641, 0.235, 1.000, 0.991, 0.403, 0.092]
                        + [1.000, 0.720, 0.612, 0.001, 1.000, 0.723],
                        [0.653, 0.235, 0.992, 1.000, 0.331, 0.132]
                        + [0.718, 1.000, 0.502, 0.001, 0.718, 1.000],
                    ]
                ),
                abs=0.02,
            )
        ...
        assert np.hstack([m.values for m in association_matrix]) == (
            pytest.approx(
                np.array(
                    [
                        [1.000, 0.043, 0.627, 0.635, 1.000, 0.019]
                        + [0.349, 0.305, 1.000, 0.003, 0.605, 0.506],
                        [0.043, 1.000, 0.228, 0.225, 0.019, 1.000]
                        + [0.092, 0.122, 0.003, 1.000, 0.000, 0.000],
                        [0.627, 0.228, 1.000, 0.993, 0.349, 0.092]
                        + [1.000, 0.762, 0.605, 0.000, 1.000, 0.754],
                        [0.635, 0.225, 0.993, 1.000, 0.305, 0.122]
                        + [0.762, 1.000, 0.506, 0.000, 0.754, 1.000],
                    ]
                ),
                abs=0.02,
            )
...
def test_model_inspection_classifier_interaction(
    ...
    try:
        ...
        assert model_inspector.feature_synergy_matrix(
            ...
            np.array(
                [
                    [0.424, 0.002, 0.002, 0.002],
                    [0.002, 0.021, 0.0, 0.002],
                    [0.002, 0.0, 0.069, 0.002],
                    [0.002, 0.002, 0.002, 0.485],
                ]
            ),
            abs=0.02,
        )
        ...
        assert synergy_matrix.values == pytest.approx(
            np.array(
                [
                    ...
                    [0.156, 1.000, 0.031, 0.157],
                    [0.040, 0.001, 1.000, 0.040],
                    [0.003, 0.000, 0.001, 1.000],
                ]
            ),
            abs=0.02,
        )
        assert model_inspector.feature_synergy_matrix(
            ...
            np.array(
                [
                    [0.424, 0.000, 0.000, 0.002],
                    [0.003, 0.021, 0.001, 0.003],
                    [0.003, 0.000, 0.069, 0.003],
                    [0.002, 0.000, 0.000, 0.485],
                ]
            ),
            abs=0.02,
        )
        ...
        assert redundancy_matrix.values == pytest.approx(
            np.array(
                [
                    [1.000, 0.001, 0.277, 0.162],
                    [0.001, 1.000, 0.007, 0.002],
                    [0.277, 0.007, 1.000, 0.628],
                    [0.162, 0.002, 0.628, 1.000],
                ]
            ),
            abs=0.02,
        )
        assert model_inspector.feature_redundancy_matrix(
            ...
            np.array(
                [
                    [0.424, 0.286, 0.040, 0.000],
                    [0.286, 0.485, 0.077, 0.002],
                    [0.040, 0.077, 0.069, 0.000],
                    [0.000, 0.002, 0.000, 0.021],
                ]
            ),
            abs=0.02,
        )
        ...
        assert redundancy_matrix.values == pytest.approx(
            np.array(
                [
                    [1.000, 0.628, 0.163, 0.002],
                    [0.629, 1.000, 0.278, 0.007],
                    [0.156, 0.267, 1.000, 0.001],
                    [0.002, 0.006, 0.001, 1.000],
                ]
            ),
            abs=0.02,
        )
        assert model_inspector.feature_redundancy_matrix(
            ...
            np.array(
                [
                    [0.424, 0.266, 0.069, 0.001],
                    [0.305, 0.485, 0.135, 0.003],
                    [0.011, 0.019, 0.069, 0.000],
        ...
        assert association_matrix.values == pytest.approx(
            np.array(
                [
                    [1.000, 0.000, 0.273, 0.161],
                    [0.000, 1.000, 0.005, 0.001],
                    [0.273, 0.005, 1.000, 0.632],
                    [0.161, 0.001, 0.632, 1.000],
                ]
            ),
            abs=0.02,
        )
        assert model_inspector.feature_association_matrix(
            ...
            np.array(
                [
                    [0.424, 0.287, 0.040, 0.000],
                    [0.287, 0.485, 0.076, 0.001],
                    [0.040, 0.076, 0.069, 0.000],
        ...
        assert association_matrix.values == pytest.approx(
            np.array(
                [
                    [1.000, 0.632, 0.161, 0.001],
                    [0.632, 1.000, 0.273, 0.005],
                    [0.161, 0.273, 1.000, 0.000],
                    [0.001, 0.005, 0.000, 1.000],
                ]
            ),
            abs=0.02,
        )
        assert model_inspector.feature_association_matrix(
            ...
            np.array(
                [
                    [0.424, 0.268, 0.068, 0.001],
                    [0.307, 0.485, 0.132, 0.002],
                    [0.011, 0.019, 0.069, 0.000],
                    [0.000, 0.000, 0.000, 0.021],
                ]
            ),
