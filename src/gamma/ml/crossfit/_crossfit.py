...
class CrossfitScores:
    """"
    Distribution of scoring values across all cross-validation fits `(crossfits)` of a
    learner pipeline.

    Generated by the :class:`.LearnerCrossfit` scoring methods.
...
class LearnerCrossfit(
    ...
    def score(
        ...
        :param sample_weight: optional weights for all observations in the training \
            sample used to fit this crossfit, to be passed on to the scoring function
    ...
    def fit_score(
        ...
        **fit_params,
        ...
        :param fit_params: optional fit parameters, to be passed on to the fit method \
            of the learner
        :param scoring: scoring to use to score the models \
